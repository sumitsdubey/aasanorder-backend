...
import com.sumit.tableserve_backend.repositories.OtpVerificationRepository;
import com.sumit.tableserve_backend.utils.OtpUtil;
...
public class OtpVerificationService {
    ...
    public OtpVerification sendOtp(String email){
        ...
        emailService.sendOtpEmail(email, "Otp for Verification", "This is a verificatio email from my side. Your otp is: " + otp+" This opt is valid for only 5 minutes");
